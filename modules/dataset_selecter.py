...
def doAndorMultiInNOut(seed_value, doOverSampling=True, topLevel='and', symbols = 4, nrEmpty = 2, andStack = 1, orStack = 1, xorStack = 1, nrAnds = 2, nrOrs = 2, nrxor = 2, trueIndexes=[1,3], test_size=0.2, orOffSet=0, xorOffSet=0, redaundantIndexes = [[0,0]]): #TODO redundancy über 2 inputs? Wird da einer ignoriert?
